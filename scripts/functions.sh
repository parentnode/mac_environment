...
checkMariadbPassword(){
	...
	mariadb_installed_specific=$(testCommand "port installed mariadb-*-server" "$mariadb_installed_array")
	if [[ "$mariadb_installed" = "true" ] || [ "$mariadb_installed_specific" = "true" ]]; then
