...
if(file_exists(getAbsolutePath("~/Dropbox/backup"))) {
	$backup_name = getAbsolutePath("~/Dropbox/backup/").$backup_time;
}
else if(file_exists(getAbsolutePath("~/Dropbox (Personal)/backup"))) {
	$backup_name = getAbsolutePath("~/Dropbox (Personal)/backup/").$backup_time;
}
else if(file_exists(getAbsolutePath("~/Google Drive/backup"))) {
	$backup_name = getAbsolutePath("~/Google Drive/backup/").$backup_time;
}
else {
